...
The app is a React app built with [Node](https://nodejs.org/en/) + [Strapi](https://github.com/strapi/strapi/tree/master/examples/getstarted).

To start local development:

```bash
git clone git@github.com:Aletheia-Data/admin.aletheiadata.org.git
